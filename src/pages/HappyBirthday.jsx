    ...
    >
      ...
      >
        ...
        <motion.path
          ...
          transition={{ duration: 2, repeat: Infinity, ease: "easeInOut" }}
          style={{ originX: "20px", originY: "85px", transformBox: "fill-box" }}
        />

        {/* Head pink */}
        <circle cx="60" cy="45" r="25" fill="#f9c2d1" stroke="#d18ca0" strokeWidth="2" />
        {/* White face patch */}
        <ellipse cx="60" cy="50" rx="18" ry="20" fill="white" />
        {/* Ears */}
        <polygon points="40,25 50,10 55,35" fill="#f7bbd9" stroke="#d18ca0" strokeWidth="1.5" />
        <polygon points="80,25 70,10 65,35" fill="#f7bbd9" stroke="#d18ca0" strokeWidth="1.5" />
        {/* Inner ears */}
    ...
    >
      ...
      {step === 3 && (
        <motion.div
          ...
          animate={{ y: 0, opacity: 1 }}
          transition={{ duration: 1 }}
          className="bg-gradient-to-br from-pink-200 to-pink-400 p-10 rounded-3xl shadow-2xl max-w-4xl w-full text-white"
        >
          <h1 className="text-4xl font-extrabold mb-6 animate-pulse italic">🎂 Happy Birthday, {name}! 🎂</h1>
          <p className="text-xl mb-4 italic">Wishing you a day filled with love, joy, and lots of cake! 🍰🎈</p>
          <p className="text-lg mb-2 italic">You are amazing, and you deserve all the best in life. 💕🌟</p>
